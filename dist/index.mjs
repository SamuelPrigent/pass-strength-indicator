...
function PasswordStrength({
  ...
  return /* @__PURE__ */ jsxs("div", { className: clsx("w-full space-y-2", className), children: [
    !hideInput && /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
      label !== void 0 ? label && (LabelComponent ? /* @__PURE__ */ jsx(LabelComponent, { htmlFor: inputId, children: label }) : /* @__PURE__ */ jsx(
        "label",
        {
          htmlFor: inputId,
      ...
      )) : LabelComponent ? /* @__PURE__ */ jsx(LabelComponent, { htmlFor: inputId, children: translation.label }) : /* @__PURE__ */ jsx(
        "label",
        {
          htmlFor: inputId,
          className: "block text-sm font-medium text-gray-900 dark:text-gray-100",
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative", children: [
        ...
        showToggleVisibility && /* @__PURE__ */ jsx(
          "button",
          {
            type: "button",
    ...
    hasValue && /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
      mode === "full" && displayRules.length > 0 && /* @__PURE__ */ jsxs("div", { className: "p-3 rounded-lg bg-gray-50 dark:bg-gray-800/50 space-y-2", children: [
        ...
        /* @__PURE__ */ jsx("ul", { className: "space-y-1", children: displayRules.map((ruleId) => {
          ...
          return /* @__PURE__ */ jsxs(
            "li",
            {
              ...
              children: [
                isPassed ? /* @__PURE__ */ jsx(CheckIcon, { className: "text-green-500 flex-shrink-0" }) : /* @__PURE__ */ jsx(XIcon, { className: "text-gray-400 flex-shrink-0" }),
                /* @__PURE__ */ jsx("span", { children: ruleLabel })
              ]
            },
            ruleId
          );
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-sm", children: [
          /* @__PURE__ */ jsx("span", { className: "text-gray-600 dark:text-gray-400 font-medium", children: mode === "full" ? "Password Strength" : "" }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
            /* @__PURE__ */ jsx("span", { className: clsx("font-medium", colors.text), children: translation.levels[level] }),
            mode === "bar-only" && /* @__PURE__ */ jsx(InfoIcon, { className: colors.text })
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: clsx("flex gap-1", barClassName), children: Array.from({ length: levels }).map((_, index) => /* @__PURE__ */ jsx(
          "div",
          {
            className: clsx(
...
export { PasswordStrength, PasswordStrength_default as default, defaultRules, evaluatePassword, getTranslation, levelToActiveBars, optionalRules, translations, usePasswordStrength };
